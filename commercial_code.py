...
# Circle rates (Commercial is 3× Residential)
circlerates = {
    "A": 774000*3,
    "B": 245520*3,
    "C": 159840*3,
...
def run_commercial():
    print("Delhi Commercial Property Calculator!".center(80))
    try:
        ...
        print(f"Building Storeys: {total_storey}, You’re Buying: {user_storey}")
